...
public class Editor extends javax.swing.JFrame {
    ...
    public Editor(String fuente, String destino, GraphicsConfiguration gc) {
        super(gc);
        this.fuente = fuente;
    ...
    */
    public void accion(){
        ...
        fuente = fuente.trim();
        if(fuente.length() == 0){
        	destino = "El cuadro de entrada no contiene\ncaracteres a"
                + " evaluar. ";
    	}
        else{
            iniciarProceso();
            ...
            case 0:{
            	...
            	*/
                if(caracter ==';'){
                    ...
                    lexema += Character.toString(caracter);
                    addList(lexema,"abre corchete");
                    lexema = "";
                }
                else if(caracter == ']'){
                    lexema += Character.toString(caracter);
                    addList(lexema,"cierra corchete");
                    lexema = "";
                }
                else if(caracter == '('){
                    lexema += Character.toString(caracter);
                    addList(lexema,"abre paréntesis");
                    lexema = "";
                }
                else if(caracter == ')'){
                    lexema += Character.toString(caracter);
                    addList(lexema,"cierra paréntesis");
                    lexema = "";
                }
		...
		* Estado 1, inicia cuando se encuentra una letra.
            	*/
                if(caracter == ';'){
                    ...
                    addList(lexema,"identificador");
                    addList("[","abre corchete");
                    estado = 0;
                    lexema = "";
                }
                else if(caracter == ']'){
                    addList(lexema,"identificador");
                    addList("]","cierra corchete");
                    estado = 0;
                    lexema = "";
                }
                else if(caracter == '('){
                    addList(lexema,"identificador");
                    addList("(","abre paréntesis");
                    estado = 0;
                    lexema = "";
                }
                else if(caracter == ')'){
                    addList(lexema,"identificador");
                    addList(")","cierra paréntesis");
                    estado = 0;
                    lexema = "";
                }
                else if(esEspacio(caracter)){
